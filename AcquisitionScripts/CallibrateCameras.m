...
disp('You can close the preview whenever you want')				
if numcam == 3
    ...
    stopprev3 = input('Press y to stop preview ', 's');
    if  stopprev3 == 'y'
    stoppreview(v1);
    stoppreview(v2);
    stoppreview(v3);
...
elseif numcam == 2
    ...
    stopprev2 = input('Press y to stop preview ', 's');
    if  stopprev2 == 'y'
    stoppreview(v1);
    stoppreview(v2);
    closepreview(v1);
...
elseif numcam == 1
    ...
    stopprev1 = input('Press y to stop preview ', 's');
    if  stopprev1 == 'y'
    stoppreview(v1);
    closepreview(v1);
    delete(v1);
